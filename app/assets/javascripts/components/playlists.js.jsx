                ...
                <tbody>
                    {all_playlists.map((playlist) =>
                        <tr>
                            ...
                            <td className="delete"><a href={"/playlists/"+playlist.id} data-method="delete" data-confirm="Are you sure?"><img src={trash} width="20px" height="20px" className="delete-trash" /></a></td>
                        </tr>
                    )}
                </tbody>
            </table>
